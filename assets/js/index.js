...
$(document).ready(function () {
  ...
  $('#workshop-date').html(workshop_date + ` <p class="is-2"><i class="fas fa-map-marker-alt" aria-hidden="true"></i>
  ...
  // Last updated
  var apiUrl = "https://api.github.com/repos/robo-mod/robo-mod.github.io/commits?sha=main&per_page=1";
